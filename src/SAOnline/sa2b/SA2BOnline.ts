...
export interface ISA2BOnlineLobbyConfig {
  data_syncing: boolean;
}

export class SA2BOnlineConfigCategory {
}

export default class SA2BOnline implements ISA_GameMain {

  ModLoader!: IModLoaderAPI;
  @InjectCore()
  core!: ISA_Main;
  @SidedProxy(ProxySide.CLIENT, path.resolve(__dirname, "SA2BOnlineClient.js"))
  client!: any;
  @SidedProxy(ProxySide.SERVER, path.resolve(__dirname, "SA2BOnlineServer.js"))
  server!: any;
